...
export class GlobeView {
  ...
  constructor(ctx: ThreeCtx, damageTex: THREE.Texture, holeTex: THREE.Texture) {
    ...
    // Поле урона (Task 1, 2A): G=гарь-градиент (широкий), B=оплавление/полынья (лёд). Каналы
    // R (глубина чаши) и A (вал+эжекта) больше не читаются — морфология кратера переехала в
